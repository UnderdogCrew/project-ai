...
def get_user_recent_session_by_user_email(user_id,skip,limit, agent_id):
    document = get_recent_chat_history_helper(user_id=user_id,skip=skip,limit=limit, agent_id=agent_id)
    if not document:
