...
class GoogleMapTools(Toolkit):
    def __init__(
        ...
        if search_places:
            self.register(self.search_places, name="google_maps_search_places")
        if get_directions:
            self.register(self.get_directions, name="google_maps_get_directions")
        if validate_address:
            self.register(self.validate_address, name="google_maps_validate_address")
        if geocode_address:
            self.register(self.geocode_address, name="google_maps_geocode_address")
        if reverse_geocode:
            self.register(self.reverse_geocode, name="google_maps_reverse_geocode")
        if get_distance_matrix:
            self.register(self.get_distance_matrix, name="google_maps_distance_matrix")
        if get_elevation:
            self.register(self.get_elevation, name="google_maps_elevation")
        if get_timezone:
            self.register(self.get_timezone, name="google_maps_timezone")
