...
class YouTubeTools(Toolkit):
    def __init__(
        ...
        if get_video_captions:
            self.register(self.get_youtube_video_captions, name="youtube_get_video_captions")
        if get_video_data:
            self.register(self.get_youtube_video_data, name="youtube_get_video_data")
    ...
    def get_youtube_video_captions(self, url: str) -> str:
        ...
        try:
            ...
            logger.error(f"Error getting captions for video: {e}")
